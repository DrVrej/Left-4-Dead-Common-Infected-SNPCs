...
-----------------------------------------------*/
ENT.Model = {"models/cpthazama/l4d1/common/common_male_baggagehandler_01.mdl","models/cpthazama/l4d1/common/common_male_pilot.mdl","models/cpthazama/l4d1/common/common_tsaagent_male01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
---------------------------------------------------------------------------------------------------------------------------------------------
